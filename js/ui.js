...
const UI = (function() {
  ...
  function renderDepo() {
    ...
    if (!slice.length) {
      tb.innerHTML = '<tr><td colspan="14" style="text-align:center;padding:20px;color:var(--mt)">Sonuç yok</td></tr>';
    ...
    for (const t of slice) {
      ...
      tr.innerHTML = `
        ...
        <td style="font-size:8px;color:var(--mt)">-</td>
  ...
  function renderKirik() {
    ...
    if (!slice.length) {
      tb.innerHTML = '<tr><td colspan="10" style="text-align:center;padding:20px;color:var(--mt)">Kırık beden yok</td></tr>';
    ...
    for (const k of slice) {
      ...
      tr.innerHTML = `
        ...
        <td><span class="sb2"><span class="rd r${k.gonderen.rank}"></span>${k.gonderen.label}</span></td>
